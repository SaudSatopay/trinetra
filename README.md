...
| 🧯 **Real-incident replay** | reconstructs the **U.S. CSB BP Texas City (2005)** sequence and replays it through the connector — fires **10 min before the documented ignition** | `/api/incident/texas-city` |
